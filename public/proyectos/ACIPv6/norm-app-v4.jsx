...
const AREAS = [
{ slug: "vivienda-unifamiliar", num: "01", title: "Viviendas unifamiliares de obra nueva", img: R.ra1, page: "proyectos",
...
{ slug: "reformas", num: "02", title: "Reformas integrales premium", img: R.ra2, page: "proyectos",
  ...
  return (
    <section className="cta-final" id="contacto">
      <div className="cta-final-inner">
        ...
        <h2>Cada proyecto comienza <span className="it">con una conversación.</span></h2>
